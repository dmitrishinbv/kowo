...
function PageKoworkStyleInc()
{
    wp_enqueue_style('pageKoworkStyle', get_template_directory_uri() . '/css/page-kowork.css', array('style'), '1.0');
}

add_action('PageKoworkStyle', 'PageKoworkStyleInc');


function PageKoworkScriptsInc()
{
    wp_enqueue_script('pageKoworkScript', get_template_directory_uri() . '/js/page-kowork/add_padding.js');
}

add_action('PageKoworkScripts', 'PageKoworkScriptsInc');
...
function PageNotFoundStyleInc()
{
    wp_enqueue_style('pageNotFoundStyle', get_template_directory_uri() . '/css/404.css', array('style'), '1.0');
}

add_action('PageNotFoundStyle', 'PageNotFoundStyleInc');
