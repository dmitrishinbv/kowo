...
new Meta_Box(array(
    ...
    'meta_array' => array(
        ...
        'event_calendar_title' => array(
            'clone' => false,
            'delete' => false,
            'input' => 'text',
            'required' => true,
            'maxlength' => 40,
            'title' => 'Коротка назва заходу для календаря',
            'placeholder' => 'Введіть коротку назву заходу (не більше 40 символів)',
            'class' => '',
        ),
        'event_fb_link' => array(
            'clone' => false,
    ...
    'groups' => array(
        array('event_date', 'event_date_finish', 'event_time', 'event_calendar_title', 'event_fb_link', 'event_register_link'),
